...
import { banner, aboutImage, aboutText, founders } from "../Components/Data";
      ...
      <section className="py-2 text-center">
        <div className="quote-wrapper container">
          <p className="quote-text fw-semibold">
            "As a practice, architecture has always been an analytical, creative, and artistic procedure"
          </p>
        </div>
      </section>
    </div >
